...
import '../../products1/provider/product1_provider.dart';
...
class _shopping_screenState extends State<shopping_screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoPageScaffold(
      ...
      //     child: Text("Shopping Cart",style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold)),
      //   ),
      // ),
            ...
            Container(
              ...
              child: Row(
                children: [
                  Container(
                    height: 50,width: 50,
                    child: Image.asset("assets/images/4i.webp",fit: BoxFit.cover),
                  ),
                  SizedBox(width: 20,),
                  Column(
            ...
            Container(
              ...
              child: Row(
                children: [
                  Container(
                    height: 50,width: 50,
                    child: Image.asset("assets/images/1i.jpg",fit: BoxFit.cover),
                  ),
                  SizedBox(width: 20,),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
            ...
            Container(
              ...
              child: Row(
                children: [
                  Container(
                    height: 50,width: 50,
                    child: Image.asset("assets/images/2i.jpg",fit: BoxFit.cover),
                  ),
                  SizedBox(width: 20,),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
